...
```md
[![Only Online Members](https://img.shields.io/discord/YOUR_SERVER_ID?logo=discord&logoColor=%23FFFFFF&label=Only%20Online%20Members&color=%236963ff)](https://discord.gg/YOUR_INVITE_CODE)
```
